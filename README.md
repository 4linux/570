Laboratório 570 - Monitoramento e Observabilidade em Cloud
=============================

Repositório para armazenar o Laboratório do curso 570 - Monitoramento e Observabilidade em Cloud da [4Linux][1]
...
```bash
git clone https://github.com/4linux/570
cd 570/
vagrant up
```
